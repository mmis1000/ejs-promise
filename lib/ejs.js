...
\n`;
    ...
    try {
      fn = new GeneratorFunction(opts.localsName + ', escape, include, rethrow, __Promise, __wrapToPromise, __outputStream, __Transform', src);
      // console.log(fn)
    }
    catch(e) {
    ...
    if (opts.client) {
      ...
      return function (local, escape, include, rethrow) {
        var outputStream = new PassThrough;
        var p = utils.wrapToPromise(fn, this, Promise, local, escape, include, rethrow, Promise, utils.wrapToPromise, outputStream, Transform);
    ...
    var returnedFn = function (data) {
      ...
      var outputStream = new PassThrough;
      var p = utils.wrapToPromise(fn, opts.context, Promise, data || {}, escape, include, rethrow, Promise, utils.wrapToPromise, outputStream, Transform);
      p.outputStream = outputStream;
      p.outputBuffer = ""
...
exports.__express = function () {
  var args = Array.prototype.slice.call(arguments)
    ...
    , data = args.shift() || {}
    , opts = args.pop() || {};
  exports.renderFile(path, data, function (err, promise) {
    if (err) {
      return cb(err)
    }
