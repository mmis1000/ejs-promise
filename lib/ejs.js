...
var outputStream = new __Stream.PassThrough;
var outputStreamBuffer = new __Stream.PassThrough;
outputStream.pipe(outputStreamBuffer);
var p = wrapToPromise(${fn.toString()}, this, __Promise, local, escape, include, rethrow, __Promise, wrapToPromise, outputStream);
p.outputBuffer = ""
...
return p;
    ...
    var returnedFn = function (data) {
      ...
      // since the stream got consumed immediatly, we need another stream to buffer it;
      p.outputStream = outputStreamBuffer;
      // since we need to escape the text, and escape only works on stream
      outputStream.setEncoding('utf8');
